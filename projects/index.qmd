...
::: {.qs-footnote-note}
**Project logo rule.** Cards use only the repository's canonical `assets/images/logo.svg` or `assets/images/logo.png`, mirrored into this website under `images/projects/`. Substitute or invented logos are not used. If the canonical logo has not yet been mirrored, the card remains text-only.
:::

...
description: "A practical guide to choosing statistical distributions for common response variables in fisheries and marine ecology."
categories:
  - Statistical ecology
  - Fisheries
  - Marine ecology
...
This page is an **extended Blog article**, not a scientific publication. It is preserved from the legacy website and is being integrated into the teaching pathway.

**Current class status:** a structured class for this topic has not yet been published. Once available, this article will link directly to it. Formal scholarly outputs remain under [Publications](/publications/).
:::
...
This article provides a practical guide for choosing distributions according to the type of response variable and the ecological or fisheries process being analysed.

> **Key message.** The distribution is a biological and statistical assumption about how the data were generated.
...
$$
Y_i \mid Y_i > 0 \sim Gamma(\mu_i, \phi)
$$
...
The intended endpoint of this content is a structured class containing the learning sequence, worked examples, exercises, code, and supporting material. That class has not yet been published, so this page currently points only to the general [Teaching catalogue](/teaching/) rather than inventing a class that does not exist.
